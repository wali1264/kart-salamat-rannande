...
export const HealthCardModal: React.FC<Props> = ({ isOpen, onClose, driver }) => {
        ...
        >
          {success ? (
            <div className="p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-2">کارت با موفقیت صادر شد</h3>
              <p className="text-slate-500">کارت راننده {driver.name} فعال و آماده استفاده است.</p>
            </div>
          ) : (
            <div className="flex flex-col h-full max-h-[90vh]">
              <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-bold text-slate-800">صدور کارت سلامت</h3>
              ...
              <div className="p-8 border-t border-slate-100">
                ...
                >
                  {loading ? 'در حال صدور...' : 'تایید و صدور کارت صحی'}
                </button>
              </div>
            </div>
          )}
